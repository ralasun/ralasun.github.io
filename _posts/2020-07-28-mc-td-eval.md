...
<table style="width:100%">
  ...
  <tr>
    ...
    <td><ul><li>low variance and high bias</li><li>could converge to true estimate, but it could fail with function approximation</li><li>more sensitive to initial value</li><li>usually more efficient than MC</li><li>can apply to markov domain</li></td>
  </tr>
</table>
