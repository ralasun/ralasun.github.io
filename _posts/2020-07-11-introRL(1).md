...
그러나, 행동을 선택할 때마다, 매번 이전 과거 정보를 파악하는 건 힘든 일입니다. 따라서 에이전트는 다음 행동을 선택하는데 <b>상태(state)정보</b>를 이용합니다.
...
<b>Partially Observable Environments</b><br>
...
<figcaption align='center'>그림 9. Deterministic vs. Stochastic</figcaption>
</p>
